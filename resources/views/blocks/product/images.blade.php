<div id="productImageMain" class="carousel carousel-dark slide" data-bs-ride="carousel">
  <div class="carousel-indicators d-none d-sm-flex">
    ...
    <button type="button" data-bs-target="#productImageMain" data-bs-slide-to="1" aria-label="Slide 2"></button>
    <button type="button" data-bs-target="#productImageMain" data-bs-slide-to="2" aria-label="Slide 3"></button>
  </div>
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="{{url('/images/placeholder.jpg')}}" class="d-block w-100" alt="...">
    </div>
...
<div class="row">
  ...
  <div class="col">
    <a href="#" data-bs-target="#productImageMain" data-bs-slide-to="1">
      <img src="{{url('/images/placeholder.jpg')}}" class="img-fluid">
    </a>
  </div>
  <div class="col">
    <a href="#" data-bs-target="#productImageMain" data-bs-slide-to="2">
      <img src="{{url('/images/placeholder.jpg')}}" class="img-fluid">
    </a>
  </div>
</div>
