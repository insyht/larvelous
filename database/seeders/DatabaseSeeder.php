...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        require_once __DIR__ . '/../../vendor/iws/database/seeders/category/BlockTemplateSeeder.php';
        require_once __DIR__ . '/../../vendor/iws/database/seeders/category/BlockVariableValueSeeder.php';
