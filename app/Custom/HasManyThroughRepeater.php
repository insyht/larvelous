...
class HasManyThroughRepeater extends Field implements CanConcealComponents
{
    use CanBeCollapsed;
    ...
    protected function setUp(): void
    {
        ...
        $this->registerListeners([
            ...
            'repeater::cloneItem' => [
                function (self $component, string $statePath, string $uuidToDuplicate): void {
                    if ($statePath !== $component->getStatePath()) {
                        return;
                    }
            ...
            'repeater::moveItemDown' => [
                function (self $component, string $statePath, string $uuidToMoveDown): void {
            ...
            'repeater::moveItemUp' => [
                function (self $component, string $statePath, string $uuidToMoveUp): void {
                    if ($component->isItemMovementDisabled()) {
                        return;
                    }
            ...
            'repeater::moveItems' => [
                function (self $component, string $statePath, array $uuids): void {
                    if ($component->isItemMovementDisabled()) {
                        return;
                    }
    ...
    public function relationship(string | Closure | null $name = null, ?Closure $callback = null): static
    {
        ...
        $this->loadStateFromRelationshipsUsing(static function (self $component) {
            $component->clearCachedExistingRecords();

            $component->fillFromRelationship();
        });

        $this->saveRelationshipsUsing(static function (self $component, HasForms $livewire, ?array $state) {
            if (! is_array($state)) {
                $state = [];
            }
    ...
    public function getRelationship(): HasOneOrMany | BelongsToMany | null | HasManyThrough
    {
